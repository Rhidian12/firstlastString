...
namespace stdproposal
{
    ...
    std::string first(const std::string& source, const size_t count)
    {
    ...
    std::string last(const std::string& source, const size_t count)
    {
        if (count >= source.size())
        {
            count = source.size();
    ...
    std::string_view first(const std::string_view source, const size_t count)
    {
        if (count >= source.size())
        {
            count = source.size();
    ...
    std::string_view last(const std::string_view source, const size_t count)
    {
        if (count >= source.size())
        {
            count = source.size();
